  ...
  const submitProduct = (e) => {
    ...
    return (
      ...
      // <div className="content">
        ...
        <div className="card">
          <div className="card-header">Add Product Form</div>
                        ...
                        <div className="col-md-8">
                          <div className="card-body">
                            ...
                            <div className="form-group row">
                              ...
                              <div className="col-sm-9">
                                {/* <input type="text" name="name" onChange={handleInput} value={form.name} className="form-control" id="inputName" placeholder="Name"/> */}
                                <select name='category_id' onChange={handleInput} value={form.category_id} id='inputCategory' className='form-select'>
                            ...
                            {/* Description */}
                            <div className="form-group row">
                              <label htmlFor="inputDesc" className="col-sm-3 col-form-label">Description</label>
                              <div className="col-sm-9">
                                <textarea className="form-control" onChange={handleInput}
                                  value={form.description} name="description" id="inputDesc" placeholder="Description"></textarea>
                              </div>
                            </div>
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-8">
                          <div className="card-body">
                            ...
                            {/* Selling Price */}
                            <div className="form-group row">
                              <label htmlFor="inputSellingPrice"className="col-sm-3 col-form-label"> Selling Price</label>
                              <div className="col-sm-9">
                                <input type="number" name="selling_price" onChange={handleInput} value={form.selling_price} className="form-control" id="inputMetaTitle" placeholder="Selling Price"/>
                                <span className="text-danger">{error.selling_price}</span>
                              </div>
                            </div>
                            {/* Original Price */}
                            <div className="form-group row">
                              <label htmlFor="inputOriginalPrice"className="col-sm-3 col-form-label">Original Price</label>
                              <div className="col-sm-9">
                                <input type="number" name="original_price" onChange={handleInput} value={form.original_price} className="form-control" id="inputOriginalPrice" placeholder="Original Price"/>
                                <span className="text-danger">{error.original_price}</span>
                              </div>
                            </div>
                            {/* Quantity */}
                            <div className="form-group row">
                              <label htmlFor="inputQuantity" className="col-sm-3 col-form-label">Quantity</label>
                              <div className="col-sm-9">
                               <input type="number" name="quantity" onChange={handleInput} value={form.quantity} className="form-control" id="inputQuantity" placeholder="Insert Quantity"/>
                              </div>
                            </div>
                            {/* Brand */}
                            <div className="form-group row">
                              <label htmlFor="inputBrand" className="col-sm-3 col-form-label">Brand</label>
                              <div className="col-sm-9">
                                <input type="text" name="brand" onChange={handleInput} value={form.brand} className="form-control" id="inputBrand" placeholder="Insert Brand"/>
